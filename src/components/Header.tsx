...
import { LogOut, Wallet, Bell, Sun, Moon, Sparkles, Zap, Flame, Crown } from "lucide-react";
import { BellIcon, MoonIcon, SunIcon, ExitIcon, EnterIcon, PersonIcon } from "@radix-ui/react-icons";
        ...
        <div className="flex items-center justify-between px-3 sm:px-4 md:px-6 py-2.5 sm:py-3">
          ...
          >
            ...
            {connected ? (
              <button
                onClick={logout}
                className="flex items-center gap-2 px-4 py-2.5 text-xs font-semibold bg-white/5 border border-white/10 text-zinc-300 rounded-[16px] hover:bg-white/10 hover:border-red-500/30 hover:text-white transition-all"
              >
